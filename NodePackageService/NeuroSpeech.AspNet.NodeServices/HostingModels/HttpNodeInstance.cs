...
namespace NeuroSpeech.AspNet.NodeServices.HostingModels
{
    ...
    /// </summary>
    /// <seealso cref="NeuroSpeech.AspNet.NodeServices.HostingModels.OutOfProcessNodeInstance" />
    internal class HttpNodeInstance : OutOfProcessNodeInstance
    {
        private static readonly Regex EndpointMessageRegex =
            new Regex(@"^\[NeuroSpeech.AspNet.NodeServices.HttpNodeHost:Listening on {(.*?)} port (\d+)\]$");
