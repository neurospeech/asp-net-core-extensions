...
namespace NeuroSpeech.AspNet.NodeServices.HostingModels
{
    /// <summary>
    ...
    /// </summary>
    /// <seealso cref="NeuroSpeech.AspNet.NodeServices.HostingModels.INodeInstance" />
    public abstract class OutOfProcessNodeInstance : INodeInstance
    {
        ...
        private const string ConnectionEstablishedMessage = "[NeuroSpeech.AspNet.NodeServices:Listening]";
